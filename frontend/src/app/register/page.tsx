...
export default function RegisterPage() {
  ...
  const handleGoogleLogin = () => {
    setError("Google sign-in will be available soon. Please use email registration.");
  };
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm space-y-6">
        ...
        <button onClick={handleGoogleLogin} type="button" className="w-full flex items-center justify-center gap-3 rounded-lg border border-border bg-background px-4 py-2.5 text-sm font-medium hover:bg-muted/50 transition-colors">
